...
let spriteSheetFilenames = ["bugs.png"];
let deathSheetFilenames = ["deathbug.png"];
...
function reset() {
  ...
  for(let i=0; i < game.totalSprites; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),32 ,32,random(100,300),random(100,300),5,random(0.5,1),6,random([0,1]));
  }
}
...
function draw() {
  switch(game.state) {
    ...
    case GameState.Start:
      ...
      textSize(40);
      textAlign(CENTER);
      text("Bug Squish Simulator",200,100);
      textSize(30);
